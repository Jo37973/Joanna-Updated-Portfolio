...
* This site is my Portfolio Page to display my skills as a full stack coding student. It includes a section about me and my background, a portfolio section that displays and has links to my GitHub repositories and projects, a viewable and downloadable resume, and has a contact section.

* As a UCI Coding-Bootcamp student, I will apply my current coding knowledge to this assignment and be resourceful to apply new knowledge by conducting research and trial and error to create an updated Portfolio that can be used for potential employers. This portfolio will include functional code, accessibility, and will be a responsive website. HTML, CSS, and JavaScript will be implemented.

* My motivation is to create a portfolio of my work that can be used to showcase my skills and knowldge as a full stack web developer to potential employers.
